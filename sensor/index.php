...
function addSensor($conn, $data) {
    $required_fields = ['id_sensor', 'id_lahan', 'tanggal_aktivasi'];
    ...
    $sql = "INSERT INTO sensor (id_sensor, id_lahan, tanggal_aktivasi) VALUES (:id_sensor, :id_lahan, :tanggal_aktivasi)";
    $stmt = $conn->prepare($sql);
...
function updateSensor($conn, $id_sensor, $data) {
    ...
    $allowed_fields = ['id_lahan', 'tanggal_aktivasi'];
    $update_fields = [];
